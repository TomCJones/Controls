...
{
    /// <summary>
    /// Configuration options for <see cref="TrustHandler"/>
    /// </summary>
    public class TrustOptions : RemoteAuthenticationOptions
    {
...
//            Events = new TrustEvents();
        ...
        public override void Validate()
        {
            ...
            if (ConfigurationManager == null)
            {
                ...
                + $"{nameof(Configuration)}, or {nameof(ConfigurationManager)} to {nameof(TrustOptions)}");
            }*/
        }

        /// <summary>
        /// Gets or sets the Authority to use when making Trust calls.
        /// </summary>
        ...
        /// </summary>
        public TrustConfiguration Configuration { get; set; }

        /// <summary>
        /// Responsible for retrieving, caching, and refreshing the configuration from metadata.
        /// If not provided, then one will be created using the MetadataAddress and Backchannel properties.
        /// </summary>
        public IConfigurationManager<TrustConfiguration> ConfigurationManager { get; set; }
        ...
        /// <summary>
        /// Gets or sets the <see cref="TrustEvents"/> to notify when processing Trust messages.
        /// </summary>
/*        public new TrustEvents Events
        {
            get => (TrustEvents)base.Events;
        ...
        */
        ...
        /// <summary>
        /// Gets or sets the <see cref="TrustProtocolValidator"/> that is used to ensure that the 'id_token' received
        ...
        */
        ...
        /// </summary>
        public TrustRedirectBehavior AuthenticationMethod { get; set; } = TrustRedirectBehavior.RedirectGet;
        ...
        /// </summary>
        public string ResponseMode { get; set; } = "form_post";  // TrustResponseMode.FormPost;

        /// <summary>
        /// Gets or sets the 'response_type'.
        /// </summary>
        public string ResponseType { get; set; } = "id_token"; // TrustResponseType.IdToken;
        ...
        /// requests through that do not contain Trust authentication responses. Disabling this and setting the
        ...
        /// </summary>
        /// <remarks>
        /// The value of <see cref="CookieBuilder.Name"/> is treated as the prefix to the cookie name, and defaults to <seealso cref="TrustDefaults.CookieNoncePrefix"/>.
        /// </remarks>
        ...
        private class TrustNonceCookieBuilder : RequestPathBaseCookieBuilder
        {
            private readonly TrustOptions _options;

            public TrustNonceCookieBuilder(TrustOptions oidcOptions)
            {
