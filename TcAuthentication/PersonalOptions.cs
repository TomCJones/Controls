// PersonalOptions.cs Copyright (c) tomjones.us
...
namespace Microsoft.AspNetCore.Authentication.Personal
{
    ...
    /// </summary>
    public class PersonalOptions : RemoteAuthenticationOptions
    {
        private CookieBuilder _nonceCookieBuilder;

        /// <summary>
        /// Initializes a new <see cref="PersonalOptions"/>
        /// </summary>
        /// <remarks>
        /// Defaults:
        /// <para>AddNonceToRequest: true.</para>
        /// <para>BackchannelTimeout: 1 minute.</para>
        /// <para>ProtocolValidator: new <see cref="PersonalProtocolValidator"/>.</para>
        /// <para>RefreshOnIssuerKeyNotFound: true</para>
        /// <para>ResponseType: <see cref="PersonalResponseType.CodeIdToken"/></para>
        /// <para>Scope: <see cref="PersonalScope.OpenIdProfile"/>.</para>
...
//            Events = new PersonalEvents();
            ...
            _nonceCookieBuilder = new PersonalNonceCookieBuilder(this)
            {
                Name = PersonalDefaults.CookieNoncePrefix,
                HttpOnly = true,
        ...
        public override void Validate()
        {
            ...
            if (ConfigurationManager == null)
            {
                ...
                + $"{nameof(Configuration)}, or {nameof(ConfigurationManager)} to {nameof(PersonalOptions)}");
            }*/
        }

        /// <summary>
        /// Gets or sets the Authority to use when making Personal calls.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="PersonalEvents"/> to notify when processing Personal messages.
        /// </summary>
/*        public new PersonalEvents Events
        {
            get => (PersonalEvents)base.Events;
        ...
        */
        ...
        /// <summary>
        /// Gets or sets the <see cref="PersonalProtocolValidator"/> that is used to ensure that the 'id_token' received
        /// is valid per: http://openid.net/specs/openid-connect-core-1_0.html#IDTokenValidation
        /// </summary>
        /// <exception cref="ArgumentNullException">if 'value' is null.</exception>
        /*
        public PersonalProtocolValidator ProtocolValidator { get; set; } = new PersonalProtocolValidator()
        {
        ...
        */
        ...
        /// </summary>
        public PersonalRedirectBehavior AuthenticationMethod { get; set; } = PersonalRedirectBehavior.RedirectGet;
        ...
        /// requests through that do not contain Personal authentication responses. Disabling this and setting the
        ...
        /// </summary>
        /// <remarks>
        /// The value of <see cref="CookieBuilder.Name"/> is treated as the prefix to the cookie name, and defaults to <seealso cref="PersonalDefaults.CookieNoncePrefix"/>.
        /// </remarks>
        ...
        private class PersonalNonceCookieBuilder : RequestPathBaseCookieBuilder
        {
            private readonly PersonalOptions _options;

            public PersonalNonceCookieBuilder(PersonalOptions oidcOptions)
            {
