...
#pragma warning disable 1591
        ...
        internal const string IDX21305 = "IDX21305: PersonalProtocolValidationContext.ProtocolMessage.Code is null, there is no 'code' in the Personal Response to validate.";
        internal const string IDX21306 = "IDX21306: The 'c_hash' claim was not a string in the 'id_token', but a 'code' was in the PersonalMessage, 'id_token': '{0}'.";
        internal const string IDX21307 = "IDX21307: The 'c_hash' claim was not found in the id_token, but a 'code' was in the PersonalMessage, id_token: '{0}'";
        ...
        internal const string IDX21310 = "IDX21310: PersonalProtocolValidationContext.ProtocolMessage.AccessToken is null, there is no 'token' in the Personal Response to validate.";
        internal const string IDX21311 = "IDX21311: The 'at_hash' claim was not a string in the 'id_token', but an 'access_token' was in the PersonalMessage, 'id_token': '{0}'.";
        internal const string IDX21312 = "IDX21312: The 'at_hash' claim was not found in the 'id_token', but a 'access_token' was in the PersonalMessage, 'id_token': '{0}'.";
        ...
        internal const string IDX21314 = "IDX21314: PersonalProtocol requires the jwt token to have an '{0}' claim. The jwt did not contain an '{0}' claim, jwt: '{1}'.";
        ...
        internal const string IDX21320 = "IDX21320: RequireNonce is '{0}'. PersonalProtocolValidationContext.Nonce and PersonalProtocol.ValidatedIdToken.Nonce are both null or empty. The nonce cannot be validated. If you don't need to check the nonce, set PersonalProtocolValidator.RequireNonce to 'false'.";
        internal const string IDX21321 = "IDX21321: The 'nonce' found in the jwt token did not match the expected nonce.\nexpected: '{0}'\nfound in jwt: '{1}'.\njwt: '{2}'.";
        internal const string IDX21322 = "IDX21322: RequireNonce is false, validationContext.Nonce is null and there is no 'nonce' in the Personal Response to validate.";
        internal const string IDX21323 = "IDX21323: RequireNonce is '{0}'. PersonalProtocolValidationContext.Nonce was null, PersonalProtocol.ValidatedIdToken.Payload.Nonce was not null. The nonce cannot be validated. If you don't need to check the nonce, set PersonalProtocolValidator.RequireNonce to 'false'. Note if a 'nonce' is found it will be evaluated.";
        ...
        internal const string IDX21328 = "IDX21328: Generating nonce for Personal message.";
        internal const string IDX21329 = "IDX21329: RequireState is '{0}' but the PersonalProtocolValidationContext.State is null. State cannot be validated.";
        internal const string IDX21330 = "IDX21330: RequireState is '{0}', the Personal Request contained 'state', but the Response does not contain 'state'.";
        internal const string IDX21331 = "IDX21331: The 'state' parameter in the message: '{0}', does not equal the 'state' in the context: '{1}'.";
        internal const string IDX21332 = "IDX21332: PersonalProtocolValidationContext.ValidatedIdToken is null. There is no 'id_token' to validate against.";
        internal const string IDX21333 = "IDX21333: PersonalProtocolValidationContext.ProtocolMessage is null, there is no Personal Response to validate.";
        internal const string IDX21334 = "IDX21334: Both 'id_token' and 'code' are null in PersonalProtocolValidationContext.ProtocolMessage received from Authorization Endpoint. Cannot process the message.";
        ...
        internal const string IDX21336 = "IDX21336: Both 'id_token' and 'access_token' should be present in PersonalProtocolValidationContext.ProtocolMessage received from Token Endpoint. Cannot process the message.";
        internal const string IDX21337 = "IDX21337: PersonalProtocolValidationContext.UserInfoEndpointResponse is null or empty, there is no Personal Response to validate.";
        ...
        internal const string IDX21341 = "IDX21341: 'RequireState' = false, PersonalProtocolValidationContext.State is null and there is no 'state' in the Personal response to validate.";
        ...
        internal const string IDX21345 = "IDX21345: PersonalProtocolValidationContext.UserInfoEndpointResponse does not contain a 'sub' claim, cannot validate.";
        internal const string IDX21346 = "IDX21346: PersonalProtocolValidationContext.ValidatedIdToken does not contain a 'sub' claim, cannot validate.";
        ...
        internal const string IDX21349 = "IDX21349: RequireNonce is '{0}'. PersonalProtocolValidationContext.Nonce was not null, PersonalProtocol.ValidatedIdToken.Payload.Nonce was null or empty. The nonce cannot be validated. If you don't need to check the nonce, set PersonalProtocolValidator.RequireNonce to 'false'. Note if a 'nonce' is found it will be evaluated.";
        ...
        internal const string IDX21808 = "IDX21808: Deserializing json into PersonalConfiguration object: '{0}'.";
        internal const string IDX21809 = "IDX21809: Serializing OpenIdConfiguration object to json string.";
        internal const string IDX21811 = "IDX21811: Deserializing the string: '{0}' obtained from metadata endpoint into PersonalConfiguration object.";
