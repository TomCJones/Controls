...
#pragma warning disable 1591
        ...
        internal const string IDX21306 = "IDX21306: The 'c_hash' claim was not a string in the 'id_token', but a 'code' was in the PortableMessage, 'id_token': '{0}'.";
        internal const string IDX21307 = "IDX21307: The 'c_hash' claim was not found in the id_token, but a 'code' was in the PortableMessage, id_token: '{0}'";
        ...
        internal const string IDX21311 = "IDX21311: The 'at_hash' claim was not a string in the 'id_token', but an 'access_token' was in the PortableMessage, 'id_token': '{0}'.";
        internal const string IDX21312 = "IDX21312: The 'at_hash' claim was not found in the 'id_token', but a 'access_token' was in the PortableMessage, 'id_token': '{0}'.";
