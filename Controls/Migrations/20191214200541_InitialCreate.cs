    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    locator = table.Column<long>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    doi_date = table.Column<long>(nullable: false),
                    first_use = table.Column<long>(nullable: false),
                    count_use = table.Column<int>(nullable: false),
                    status = table.Column<string>(nullable: true),
                    methods = table.Column<string>(nullable: true),
                    cert = table.Column<string>(nullable: true),
                    Clientlocator = table.Column<long>(nullable: true)
                },
                constraints: table =>
                {
